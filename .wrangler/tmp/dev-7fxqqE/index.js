...
// .wrangler/tmp/bundle-lIGVYM/checked-fetch.js
...
// .wrangler/tmp/bundle-lIGVYM/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-lIGVYM/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function flattenedVerify(jws, key, options) {
  ...
  const data = concat(encoder.encode((_a2 = jws.protected) !== null && _a2 !== void 0 ? _a2 : ""), encoder.encode("."), typeof jws.payload === "string" ? encoder.encode(jws.payload) : jws.payload);
  let signature;
  try {
...
var secs_default = /* @__PURE__ */ __name((str2) => {
...
__publicField(AuthService, "JWT_EXPIRES_IN", "24h");
...
var AudioService = class {
  ...
  async textToSpeech(data) {
    ...
    return {
      audioBuffer: data.responseType === "binary" ? this.base64ToArrayBuffer(audioData) : void 0,
      audioData: data.responseType === "binary" ? void 0 : audioData,
      format: "wav"
    };
  }
...
__name(AudioService, "AudioService");
